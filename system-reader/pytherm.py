"""
Test coming from there: https://github.com/BennyCarbajal/PyTherm
Using the OpenHardwareMonitor dll file
In readme, should give CPU, HDD and GPU temperatures, but only gives CPU temps on MSi laptop
"""
